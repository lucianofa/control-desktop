...
public class FrmVendaGestao extends FormularioGestao {
	...
	public FrmVendaGestao() {
		setTitulo("Vendas");
		setDescricao("Gestão das vendas do Dia");
		...
		tabela.adicionarColuna(0, "Nr°", "id");
		tabela.adicionarColuna(1, "Data", "data");
		tabela.adicionarColuna(2, "Descrição", "descricao");
		tabela.adicionarColuna(3, "R$ Venda", "valorAplicado");
		tabela.adicionarColuna(4, "R$ Dinheiro", "pagamento.dinheiro");
		tabela.adicionarColuna(5, "R$ Pix", "pagamento.pix");
		tabela.adicionarColuna(6, "R$ Débito", "pagamento.debito");
		tabela.adicionarColuna(7, "R$ Boleto", "pagamento.boleto");
		tabela.adicionarColuna(8, "R$ Crédito", "pagamento.credito");
		tabela.adicionarColuna(9, "R$ Carnê", "pagamento.parcelado");
		
		tabela.definirLarguraColunas(40, 60, 150, 70,70,70,70,70,70,70);
	...
	public void filtrar() {
		zerarTotal();
		List<ContratoVenda> response = service.listarVendaPagamentos(Context.getEmpresaId(), LocalDate.now());
		if(response.size()==0) {
